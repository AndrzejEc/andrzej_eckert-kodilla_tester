...
public class UserDialogs {
    ...
    public static String getUserSelection(){
        ...
        while (true){
            ...
            switch (calc){
                ...
                case "D":return"DIV";
                case "M":return"MUL";
                default: System.out.println("Wrong calculation. Try again.");
    ...
    public static String getUserColorSelection(){
        Scanner scanner=new Scanner(System.in);
        while (true){
            System.out.println("Select Color R-red, G-green, B-blue: ");
            String calc = scanner.nextLine().trim().toUpperCase();
            switch (calc){
                case "R":return"RED";
                case "G":return"GREEN";
                case "B":return"BLUE";
                default: System.out.println("Wrong color. Try again.");
